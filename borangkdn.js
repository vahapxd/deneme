    ...
    if(interaction.isButton()) {
      ...
      if(interaction.customId === "etkinlik") {
        ...
        if(member.roles.cache.has(config.buttons.etkinlik)) {
          ...
          await interaction.reply({ content: `<@&${config.buttons.etkinlik}> Rencia Tarafından Erişim Aldın`, ephemeral: true });
        } else {
      ...
      if(interaction.customId === "cekilis") {
        ...
        if(member.roles.cache.has(config.buttons.çekiliş)) {
          ...
          await interaction.reply({ content: `<@&${config.buttons.çekiliş}> Rencia Tarafından Erişim Aldın`, ephemeral: true });
        } else {
